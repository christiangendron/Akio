...
function Logged() {
    ...
    return (
        <>
            ...
            <MenuItem label='My posts' handler={() => navigation.push('Overview', { id: authContext.userId, name: authContext.username, type: 'user-posts', withSearch: true })} extraStyles=' mx-2 mt-2'/>
