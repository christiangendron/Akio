...
export default function PostInteraction(props: PostProps) {
  ...
  return (
    <View className='flex-row mx-2 mb-2 mt-2'>
      <Pill text={props.community_name} handler={() => navigation.push('Community', { name: props.community_name, id: props.community_id, type: 'post', withSearch: true, withGeneration: true })}/>
